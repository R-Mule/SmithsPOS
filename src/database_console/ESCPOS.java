...
public class ESCPOS {
    ...
    public static final byte[] Down_Line = {0x0A};         //move cursor to the second line left corner.
    ...
    public static final byte[] VISOR_CLEAR = {0x1F};          //clear entire display.
    public static final byte[] CODE_TABLE_00 = {0x1B, 0x74, 0x00};
    public static final byte[] CODE_TABLE_13 = {0x1B, 0x74, 0x13};

    public static final byte[] SEND40 = {0x21, 0x23, 0x41, 0x0D};
    public static final byte[] HIDE_CURSOR = {0x14};
    public static final byte[] MODE = {0x17};
